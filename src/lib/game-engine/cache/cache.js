...
class ServiceWorkerCache {
    ...
    static listen() {
        ...
        self.addEventListener('fetch', (e) => {
            if (!('request' in e && 'respondWith' in e && typeof e.respondWith == 'function'))
                return;
            Thread.log('fetching...');
            e.respondWith(this.cCacheFirst(e.request));
        });
        self.addEventListener("activate", (e) => {
            ...
            if ('waitUntil' in e
                ...
                && typeof ((_a = self.registration) === null || _a === void 0 ? void 0 : _a.navigationPreload.enable) == 'function')
     ...
     */
    static async cCacheFirst(request) {

...
*/
export function invert(mat, col) {
...
*/
export function toMatrix(vec, col) {
    const m = [];
...
*/
export function transpose(m, col) {
    const T = [];
...
*/
export function deleteRowAndCol(m, row, col) {
    const res = [];
...
*/
export function substituteColumn(m, col, vec) {
    const res = [];
    for (let el of m) {
        res.push([...el]);
    }
...
*/
export function dot(m1, col1, m2) {
    const res = [];
